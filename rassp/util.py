...
# Function overview: cd handles a specific workflow step in this module.
...
# Function overview: array_to_conf handles a specific workflow step in this module.
...
# Function overview: add_empty_conf handles a specific workflow step in this module.
...
# Function overview: numpy handles a specific workflow step in this module.
def numpy(x):
   """
...
# Function overview: move handles a specific workflow step in this module.
...
# Function overview: recursive_update handles a specific workflow step in this module.
...
# Function overview: morgan4_crc32 handles a specific workflow step in this module.
def morgan4_crc32(m):
...
# Function overview: num_unique_frag_formulae handles a specific workflow step in this module.
...
# Function overview: check_if_mol_is_valid handles a specific workflow step in this module.
...
# Function overview: percentile handles a specific workflow step in this module.
def percentile(n):
    """
    ...
    # Function overview: percentile_ handles a specific workflow step in this module.
    def percentile_(x):
        return x.quantile(n)
    percentile_.__name__ = 'percentile_{:2.0f}'.format(n*100)
    return percentile_

# Function overview: spect_list_to_string handles a specific workflow step in this module.
def spect_list_to_string(spect_list):
    assert isinstance(spect_list, list)
    return pickle.dumps(spect_list)

# Function overview: spect_list_from_string handles a specific workflow step in this module.
def spect_list_from_string(spect_string: str):
    assert isinstance(spect_string, str)
    return pickle.loads(spect_string)

# Function overview: read_molfile handles a specific workflow step in this module.
