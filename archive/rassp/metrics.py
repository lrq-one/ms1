...
# Purpose: Core shared utilities/metrics/config glue used across the project.
...
# Function overview: spect_to_bins handles a specific workflow step in this module.
...
# Function overview: norm_vect handles a specific workflow step in this module.
...
# Function overview: bin_spectra handles a specific workflow step in this module.
...
# Function overview: convert_list_to_sdict handles a specific workflow step in this module.
...
# Function overview: convert_svect_to_sdict handles a specific workflow step in this module.
...
# Function overview: convert_list_to_svect handles a specific workflow step in this module.
...
# Function overview: get_tup_rep handles a specific workflow step in this module.
def get_tup_rep(d):
...
# Function overview: resort_by_intensity_decreasing handles a specific workflow step in this module.
...
# Function overview: round_sdict_masses handles a specific workflow step in this module.
...
# Function overview: sdp handles a specific workflow step in this module.
...
# Function overview: dp handles a specific workflow step in this module.
...
# Function overview: dot_product handles a specific workflow step in this module.
...
# Function overview: topk_precision handles a specific workflow step in this module.
def topk_precision(
...
# Function overview: intensity_weighted_barcode_precision handles a specific workflow step in this module.
...
# Function overview: intensity_weighted_barcode_false_positive_rate handles a specific workflow step in this module.
...
# Function overview: topk_frac handles a specific workflow step in this module.
...
# Function overview: spect_entropy handles a specific workflow step in this module.
...
# Function overview: sdp_old handles a specific workflow step in this module.
def sdp_old(x, y):
    x = norm_vect(x)
    y = norm_vect(y)
    return dot_product(x, y)

# Function overview: dp_old handles a specific workflow step in this module.
def dp_old(x, y):
    x = norm_vect(x)
    y = norm_vect(y)
...
# Function overview: unweighted_recall handles a specific workflow step in this module.
...
# Function overview: intensity_weighted_recall handles a specific workflow step in this module.
...
# Function overview: wishart_dot_product handles a specific workflow step in this module.
def wishart_dot_product(pred_masses, pred_intensities, true_masses, true_intensities, mass_pow=0.5, intensity_pow=0.5):
    ...
    # Function overview: get_adjusted_intensity handles a specific workflow step in this module.
    ...
    # Function overview: get_total_intensity handles a specific workflow step in this module.
...
# Function overview: l1 handles a specific workflow step in this module.
...
# Function overview: invalid_mass handles a specific workflow step in this module.
...
# Function overview: top_k handles a specific workflow step in this module.
